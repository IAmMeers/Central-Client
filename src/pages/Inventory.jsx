...
const Inventory = () => {
  ...
  const listItems = (item) => {
    return (
        ...
        <tr key={item.Item_name} className="threshold-exceed">
      ...
      <div className="inventory-container">
        ...
        <section className="store-section">
          ...
          <table className="inventory-table">
            ...
            <tbody>{filteredInventory.map((item) => listItems(item))}</tbody>
          </table>
        </section>
        <button
          className="btn"
